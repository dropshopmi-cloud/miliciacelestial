  ...
  ({ className, variant = 'default', ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        variant === 'sacred' && "border-gold/30 shadow-lg hover:shadow-xl hover:border-gold/50 card-3d",
        variant === 'elevated' && "shadow-xl border-gold/20 bg-gradient-to-br from-card to-muted/50",
        className
      )}
      {...props}
    />
