// Central Mariana - Conteúdo Completo

export const mariaCaminhaComigo = {
  title: 'Maria Caminha Comigo',
  subtitle: '7 Dias com Nossa Senhora',
  days: [
    {
      day: 1,
      title: 'O Sim de Maria',
      reflection: 'Maria foi escolhida por Deus para ser a Mãe do Salvador. Quando o Anjo Gabriel apareceu a ela com a notícia surpreendente, Maria não hesitou em dizer "sim". Esse "sim" mudou a história da humanidade. Ela não tinha todas as respostas, não entendia completamente o plano divino, mas confiou. Sua entrega foi total, sem reservas, sem condições. Hoje, somos convidados a dar o nosso "sim" a Deus, mesmo quando o caminho parece incerto. Maria nos ensina que a fé não exige compreensão total — exige confiança. Quando dizemos "sim" ao Senhor, Ele transforma o impossível em milagre. Reflita: em que área da sua vida Deus está pedindo um "sim" que você ainda não deu? Que medo ou dúvida te impede de confiar plenamente?',
      prayer: 'Ó Maria, Mãe de Deus e nossa Mãe, ensina-me a dizer "sim" como tu disseste. Que eu tenha a coragem de entregar minha vida nas mãos de Deus, confiando em Seu plano perfeito. Intercede por mim junto ao teu Filho, para que eu seja fiel à vontade divina em todos os momentos. Amém.'
    },
    {
      day: 2,
      title: 'A Visitação – Servir com Alegria',
      reflection: 'Ao saber que sua prima Isabel também esperava um filho, Maria não pensou duas vezes: levantou-se e foi às pressas servi-la. Ela carregava em seu ventre o Salvador do mundo, mas não se colocou acima dos outros. Pelo contrário, foi servir. Maria nos ensina que a verdadeira grandeza está no serviço. Não importa quão abençoados sejamos — somos chamados a compartilhar essa bênção. O encontro de Maria com Isabel foi marcado pela alegria do Espírito Santo. João Batista saltou no ventre de Isabel, e ambas glorificaram a Deus. Quando servimos com amor, o Espírito Santo se manifesta. Hoje, pense: quem ao seu redor precisa da sua presença, do seu cuidado, da sua atenção? Vá ao encontro dessa pessoa, como Maria foi ao encontro de Isabel.',
      prayer: 'Nossa Senhora da Visitação, ensina-me a servir com alegria e prontidão. Que eu não espere ser pedido, mas que vá ao encontro de quem precisa de mim. Que meu coração transborde de generosidade, como o teu. Amém.'
    },
    {
      day: 3,
      title: 'O Magnificat – Louvor e Gratidão',
      reflection: 'O Magnificat é o cântico de Maria, uma das orações mais belas da Escritura: "Minha alma engrandece ao Senhor, e meu espírito exulta em Deus, meu Salvador." Maria reconheceu a ação de Deus em sua vida e respondeu com louvor. Ela não se vangloriou de ter sido escolhida; ela glorificou Aquele que a escolheu. O louvor é a resposta natural de quem reconhece a bondade de Deus. Mesmo nas dificuldades, Maria encontrou motivos para louvar. Ela sabia que Deus derruba os poderosos e exalta os humildes, que Ele enche de bens os famintos e despede os ricos de mãos vazias. Hoje, faça como Maria: pare e reconheça as bênçãos em sua vida. Mesmo que tudo pareça difícil, há motivos para agradecer. O louvor muda a perspectiva e abre o coração para novas graças.',
      prayer: 'Maria, Mãe do louvor e da gratidão, ensina-me a reconhecer as maravilhas que Deus faz em minha vida. Que eu nunca deixe de louvar ao Senhor, mesmo nos momentos difíceis. Que o Magnificat seja a oração do meu coração. Amém.'
    },
    {
      day: 4,
      title: 'Maria aos Pés da Cruz',
      reflection: 'No momento mais doloroso da história, Maria estava lá. Aos pés da cruz, ela assistiu à morte de seu Filho. Não fugiu, não se escondeu, não abandonou. Permaneceu firme, unindo sua dor à dor de Cristo. Maria nos ensina a perseverar na fé mesmo quando tudo parece perdido. Ela não entendeu tudo naquele momento, mas confiou que Deus tinha um plano maior. Sua presença silenciosa foi um ato de fé heroica. Quando enfrentamos nossas próprias cruzes — doenças, perdas, sofrimentos —, Maria nos convida a permanecer fiéis. A cruz não é o fim; é o caminho para a ressurreição. Reflita: qual é a sua cruz hoje? Você a carrega sozinho ou a entrega aos pés de Jesus, com Maria ao seu lado?',
      prayer: 'Nossa Senhora das Dores, permanece ao meu lado nos momentos de sofrimento. Quando a cruz parecer pesada demais, lembra-me de que não estou sozinho. Ajuda-me a unir minhas dores às dores de Cristo, transformando meu sofrimento em oferenda de amor. Amém.'
    },
    {
      day: 5,
      title: 'Maria e a Igreja Nascente',
      reflection: 'Após a Ascensão de Jesus, Maria permaneceu com os discípulos em oração, esperando a vinda do Espírito Santo. Ela foi a primeira discípula, a primeira a acreditar, e continuou sendo pilar da comunidade nascente. No Cenáculo, Maria rezou junto com os apóstolos, unindo sua fé à fé deles. E quando o Espírito Santo desceu em Pentecostes, ela estava lá, testemunhando mais uma vez a ação de Deus. Maria nos ensina a importância da comunidade, da oração em grupo, da perseverança na fé junto com outros irmãos. Nenhum cristão caminha sozinho. Somos Igreja, somos corpo de Cristo, e Maria é nossa Mãe espiritual que nos une.',
      prayer: 'Maria, Mãe da Igreja, ensina-me a viver em comunidade. Que eu valorize a oração em grupo, o apoio mútuo e a partilha da fé. Intercede para que o Espírito Santo renove a minha vida e a vida da Igreja. Amém.'
    },
    {
      day: 6,
      title: 'O Coração Imaculado de Maria',
      reflection: 'O Coração Imaculado de Maria é refúgio seguro para todos os que sofrem, temem ou se sentem perdidos. Deus preservou o coração de Maria de toda mancha de pecado, tornando-a modelo perfeito de pureza e amor. Consagrar-se ao Coração Imaculado de Maria é colocar-se sob sua proteção maternal. É reconhecer que ela intercede por nós junto a Jesus com uma ternura que só uma mãe possui. Maria guarda em seu coração todas as nossas dores, alegrias, sonhos e medos. Ela nos apresenta ao Pai com amor infinito. Hoje, entregue seu coração ao Coração Imaculado de Maria. Peça que ela purifique seus sentimentos, cure suas feridas e te conduza mais perto de Jesus.',
      prayer: 'Ó Coração Imaculado de Maria, acolhe-me como teu filho(a). Purifica meu coração de todo pecado e egoísmo. Conduz-me a Jesus pelo caminho da humildade e do amor. Consagro-me a ti, ó Mãe, para que tudo em mim glorifique a Deus. Amém.'
    },
    {
      day: 7,
      title: 'Maria, Estrela da Evangelização',
      reflection: 'Maria é a Estrela da Evangelização porque foi a primeira a levar Jesus ao mundo. Antes mesmo de Jesus nascer, Maria já O levava em seu ventre para abençoar Isabel e João Batista. Ela foi a primeira missionária. Ser evangelizador não significa apenas pregar com palavras — significa viver de forma que as pessoas vejam Cristo em nós. Maria evangelizou com sua vida: com humildade, silêncio, serviço e amor. Hoje, somos chamados a ser como Maria: levar Jesus aonde formos. No trabalho, na família, entre amigos, na rua — somos portadores de Cristo. Que nossa vida seja um testemunho vivo do amor de Deus, como foi a vida de Maria.',
      prayer: 'Maria, Estrela da Evangelização, faz de mim um instrumento de Deus. Que eu leve Jesus a todos os lugares por onde passar. Que minha vida seja testemunho do Evangelho, e que, como tu, eu diga "sim" à missão que Deus me confiou. Amém.'
    },
  ]
};

export const titulosMarianos = [
  {
    id: 'aparecida',
...
export const historiaDeNossaSenhora = {
  title: 'História de Nossa Senhora',
  sections: [
    {
      subtitle: 'Quem foi Maria',
      content: 'Maria, mãe de Jesus, nasceu na Palestina, provavelmente em Nazaré ou Jerusalém. A tradição cristã identifica seus pais como São Joaquim e Santa Ana. Desde sua concepção, Maria foi preservada do pecado original — o dogma da Imaculada Conceição, proclamado pelo Papa Pio IX em 1854. Jovem, humilde e cheia de graça, Maria foi escolhida por Deus para ser a Mãe do Salvador. Sua vida foi marcada pela simplicidade, pela oração e pela obediência total à vontade divina. Ela é chamada de "cheia de graça" pelo Anjo Gabriel, revelando que Deus a cumulou com dons especiais desde antes de seu nascimento.'
    },
    {
      subtitle: 'Papel na Fé Cristã',
      content: 'Maria ocupa um lugar único na fé cristã. Ela é a Theotokos — a Mãe de Deus — título definido no Concílio de Éfeso em 431 d.C. É a medianeira de todas as graças, a advogada dos pecadores, a Rainha dos Céus e da Terra. Na Anunciação, seu "sim" possibilitou a Encarnação do Verbo. No Calvário, ela se tornou Mãe de todos nós quando Jesus a confiou ao apóstolo João: "Eis aí tua mãe." Em Pentecostes, ela rezou com os apóstolos, sustentando a Igreja nascente. Maria é modelo de fé, esperança e caridade. Sua vida inteira foi um "sim" contínuo a Deus.'
    },
    {
      subtitle: 'Importância Espiritual Atual',
      content: 'Nos tempos atuais, a devoção a Maria é mais necessária do que nunca. Ela apareceu em diversos lugares do mundo — Fátima, Lourdes, Guadalupe, Aparecida — sempre com uma mensagem de conversão, oração e penitência. Maria é refúgio dos pecadores, consolação dos aflitos e estrela que guia os perdidos. Consagrar-se a Maria é entregar-se totalmente a Jesus por meio dela. Como disse São Luís de Montfort: "A devoção a Maria é o caminho mais seguro, mais fácil e mais perfeito para chegar a Jesus Cristo." Em um mundo marcado pela dor, pela confusão e pelo afastamento de Deus, Maria continua sendo o porto seguro que nos conduz ao Coração de Jesus.'
    }
  ]
};

export const aparicoes = [
  {
    id: 'fatima',
    title: 'Fátima (1917)',
    context: 'Em plena Primeira Guerra Mundial, a Virgem Maria apareceu a três pastorinhos em Fátima, Portugal. As seis aparições, de maio a outubro de 1917, trouxeram uma mensagem urgente de conversão. Os três segredos revelados incluíam uma visão do inferno, a previsão da Segunda Guerra Mundial e um atentado contra o Papa. O Milagre do Sol, presenciado por milhares, selou a autenticidade das aparições.',
    message: 'Oração, penitência e conversão. Nossa Senhora pediu a reza diária do Rosário e a consagração ao seu Imaculado Coração como caminho de paz para o mundo.',
    prayer: 'Ó Santíssima Trindade, Pai, Filho e Espírito Santo, eu Vos adoro profundamente e Vos ofereço o Preciosíssimo Corpo, Sangue, Alma e Divindade de Nosso Senhor Jesus Cristo, presente em todos os sacrários da Terra, em reparação dos ultrajes com que Ele é ofendido. Pelos méritos infinitos do Seu Sagrado Coração e por intercessão do Imaculado Coração de Maria, peço-Vos a conversão dos pobres pecadores. Amém.'
  },
  {
    id: 'aparecida',
    title: 'Aparecida (1717)',
    context: 'No interior de São Paulo, três humildes pescadores encontraram nas águas do rio Paraíba do Sul uma imagem de Nossa Senhora da Conceição. A imagem, quebrada e escurecida, se tornou símbolo de fé para todo o Brasil. Milagres começaram a acontecer, e a devoção cresceu até que Nossa Senhora Aparecida foi proclamada Padroeira do Brasil em 1930.',
    message: 'Deus escolhe o que é pequeno e humilde para confundir o que é grande. A fé simples do povo brasileiro encontrou em Aparecida uma Mãe que acolhe a todos, sem distinção.',
    prayer: 'Senhora Aparecida, eu renovo minha consagração a vós. Sou todo vosso e tudo o que tenho vos ofereço. Protegei-me, guiai-me e conduzi-me ao vosso Filho Jesus. Amém.'
  },
  {
    id: 'lourdes',
    title: 'Lourdes (1858)',
    context: 'Em Lourdes, França, a Virgem Maria apareceu 18 vezes a Bernadette Soubirous, uma jovem pobre e doente. Na gruta de Massabielle, Maria se apresentou como "Eu sou a Imaculada Conceição", confirmando o dogma proclamado quatro anos antes. Uma fonte de água brotou no local, e desde então milhares de curas milagrosas foram registradas, muitas reconhecidas oficialmente pela Igreja.',
...
export const consagracao = {
  ...
  intro: 'A Consagração a Nossa Senhora é um ato de entrega total a Maria, reconhecendo-a como Mãe, Rainha e Medianeira. Inspirada por São Luís Maria Grignion de Montfort, esta prática consiste em viver para Jesus por meio de Maria, entregando-lhe tudo: corpo, alma, bens espirituais e materiais. Consagrar-se a Maria é o caminho mais seguro, mais fácil e mais perfeito para chegar a Jesus Cristo.',
  preparacao: [
    {
      day: 1,
...
export const leiturasMarianasData = [
  {
    ...
    summary: 'Como Maria cooperou no plano redentor de Deus.',
    content: 'Maria não é apenas uma figura histórica — ela é parte essencial do plano de salvação. Seu "sim" na Anunciação possibilitou a Encarnação do Verbo. Sem Maria, o plano de Deus teria tomado outro caminho. Ela cooperou livremente, com fé e amor, tornando-se a Nova Eva que desfaz o pecado da primeira. A Igreja ensina que Maria é co-redentora — não no sentido de ser igual a Cristo, mas no sentido de que sua cooperação foi única e insubstituível. Aos pés da cruz, ela uniu seu sofrimento ao de Jesus, oferecendo-se como mãe espiritual de toda a humanidade. Hoje, Maria continua intercedendo por nós no céu, apresentando nossas preces a Jesus com uma ternura que só uma mãe possui.',
    recommendedBooks: ['Tratado da Verdadeira Devoção à Santíssima Virgem – São Luís de Montfort', 'Lucas 1-2']
  },
  {
    id: 2,
    title: 'Maria e o Rosário',
    summary: 'A importância do Rosário na vida espiritual.',
    content: 'O Rosário é a oração mariana por excelência. Ao rezá-lo, meditamos nos mistérios da vida de Jesus e de Maria, unindo nossa voz à da Virgem. São Padre Pio dizia: "O Rosário é a arma." Em Fátima, Nossa Senhora pediu que rezássemos o Rosário todos os dias pela paz do mundo. Cada Ave Maria é um abraço espiritual de Maria. Cada mistério é uma janela para a vida de Cristo. O Rosário nos ensina a contemplar, a meditar, a entrar no silêncio onde Deus fala. Não é uma oração mecânica — é um encontro íntimo com o coração de Maria e, através dele, com o coração de Jesus.',
    recommendedBooks: ['O Segredo do Rosário – São Luís de Montfort', 'Rosarium Virginis Mariae – São João Paulo II']
  },
  {
    id: 3,
    title: 'As Virtudes de Maria para os Dias de Hoje',
    summary: 'Como imitar as virtudes marianas na vida moderna.',
    content: 'Em um mundo que valoriza o barulho, a pressa e a autopromoção, as virtudes de Maria parecem contracorrente: humildade, silêncio, obediência, confiança. Mas são exatamente essas virtudes que trazem paz interior e nos aproximam de Deus. Imitar Maria não significa ser passivo — significa ser corajoso o suficiente para confiar quando tudo parece incerto, para servir quando ninguém está olhando, para permanecer fiel quando o mundo convida à desistência. Maria viveu essas virtudes não em um convento, mas no meio da vida cotidiana: cozinhando, lavando, cuidando da família. A santidade não exige circunstâncias extraordinárias — exige amor extraordinário nas circunstâncias comuns.',
    recommendedBooks: ['Glórias de Maria – Santo Afonso de Ligório', 'Maria de Nazaré – Joseph Ratzinger']
  },
];

export const leiturasVirtudesData = [
  {
    id: 1,
    title: 'A Paciência como Caminho de Santidade',
    summary: 'Aprender a esperar com fé e serenidade.',
    content: 'A paciência é uma das virtudes mais difíceis de praticar, mas também uma das mais transformadoras. Em um mundo que exige resultados imediatos, esperar parece um desperdício. Mas Deus trabalha no tempo, não contra o tempo. A paciência cristã não é passividade — é confiança ativa de que Deus está agindo, mesmo quando não vemos. Os santos nos ensinam que a paciência purifica a alma. Santa Teresinha do Menino Jesus dizia que cada pequeno sofrimento suportado com paciência é uma oferenda de amor a Deus. Hoje, pratique a paciência nas filas, no trânsito, com as pessoas difíceis, consigo mesmo. Cada momento de paciência é um passo no caminho da santidade.',
    recommendedBooks: ['História de uma Alma – Santa Teresinha', 'Tiago 1,2-4']
  },
  {
    id: 2,
    title: 'A Caridade que Transforma',
    summary: 'O amor ao próximo como fundamento da vida cristã.',
    content: 'São Paulo nos diz que se não temos caridade, nada somos. A caridade não é apenas dar esmolas — é amar o outro como Cristo nos ama: sem condições, sem julgamento, sem limites. A caridade é ver Cristo no rosto do pobre, do doente, do excluído. É servir sem esperar recompensa. É perdoar quando a justiça humana pediria vingança. A caridade transforma não apenas quem recebe, mas principalmente quem dá. Quando amamos de verdade, descobrimos que somos amados primeiro por Deus.',
    recommendedBooks: ['1 Coríntios 13', 'Deus Caritas Est – Papa Bento XVI']
  },
  {
    id: 3,
    title: 'A Esperança nos Tempos Difíceis',
    summary: 'Manter a esperança quando tudo parece escuro.',
    content: 'A esperança cristã não é otimismo ingênuo — é certeza de que Deus é fiel às Suas promessas. Mesmo quando tudo parece desmoronar, a esperança nos sustenta porque não depende das circunstâncias, mas de Deus. Os tempos difíceis são provas de fé, oportunidades de crescimento, momentos em que somos convidados a confiar mais profundamente. A esperança não nega o sofrimento — ela o ilumina com a luz da eternidade. Como dizia São João Paulo II: "Não tenham medo! Abram as portas a Cristo!"',
    recommendedBooks: ['Spe Salvi – Papa Bento XVI', 'Romanos 8,28']
  },
];

export const leiturasVidaSantosData = [
  {
    id: 1,
    title: 'São Francisco de Assis – O Pobre de Deus',
    summary: 'A vida radical de pobreza e amor à criação.',
    content: 'Francisco de Assis nasceu rico, mas escolheu a pobreza. Abandonou tudo para seguir Cristo literalmente, vivendo como os pobres, cuidando dos leprosos e pregando o Evangelho com simplicidade. Sua conversão começou quando ouviu a voz de Cristo na igreja de São Damião: "Francisco, vai e repara a minha casa." Ele entendeu que não se tratava apenas do edifício, mas da Igreja inteira. São Francisco nos ensina que a verdadeira riqueza está em Deus. Sua vida é um convite a desapegar-se do supérfluo e abraçar o essencial.',
    recommendedBooks: ['Fioretti de São Francisco', 'Cântico das Criaturas']
  },
  {
    id: 2,
    title: 'Santa Teresa de Ávila – Mística e Reformadora',
    summary: 'A experiência mística e a reforma do Carmelo.',
    content: 'Teresa de Ávila foi uma das maiores místicas da história da Igreja. Doutora da Igreja, reformou a Ordem Carmelita e escreveu obras fundamentais sobre a vida de oração, como "O Castelo Interior" e "Caminho de Perfeição". Sua relação com Deus era profunda e pessoal. Ela experimentou visões, êxtases e a transverberação do coração. Mas Teresa também era prática, determinada e bem-humorada. Sua frase célebre resume sua espiritualidade: "Deus passeia entre as panelas."',
    recommendedBooks: ['O Castelo Interior – Santa Teresa de Ávila', 'Caminho de Perfeição']
  },
  {
    id: 3,
    title: 'São José – O Justo e Silencioso',
    summary: 'O modelo de pai, esposo e homem de fé.',
    content: 'São José é o santo do silêncio. Nos Evangelhos, não há uma única palavra registrada dele. Mas suas ações falam mais alto que qualquer discurso. Ele acolheu Maria, protegeu Jesus, trabalhou humildemente como carpinteiro e obedeceu a Deus sem questionar. São José é modelo para todos: pai zeloso, esposo fiel, trabalhador honesto, homem de oração. Papa Francisco o chamou de "homem que sonha" — porque é nos sonhos que Deus lhe revelou Sua vontade.',
    recommendedBooks: ['Patris Corde – Papa Francisco', 'Mateus 1-2']
  },
];

export const leiturasFormacaoData = [
  {
    id: 1,
